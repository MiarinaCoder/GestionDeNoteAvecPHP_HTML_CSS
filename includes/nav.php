<nav class="sidebar-nav">
    <ul>
        <li>
            <a href="../etudiants/index.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'etudiants') !== false ? 'active' : ''; ?>">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                Étudiants
            </a>
        </li>
        <li>
            <a href="../professeurs/index.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'professeurs') !== false ? 'active' : ''; ?>">
        ...
        <li>
            <a href="../organismes/index.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'organismes') !== false ? 'active' : ''; ?>">
        ...
        <li>
            <a href="../soutenances/index.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'soutenances') !== false ? 'active' : ''; ?>">
        ...
        <li>
            <a href="../rapports/note.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'rapports') !== false ? 'active' : ''; ?>">
